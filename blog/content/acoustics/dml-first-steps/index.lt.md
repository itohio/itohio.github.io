...
Distributed Mode Loudspeaker naudoja lengvą, standžią plokštę (paprastai polistirenas, korys arba kompozitas), varomą vieno ar daugiau žadinimo elementų (exciters). Vietoj to, kad judėtų kaip standus stūmoklis, plokštė suskyla į kelias rezonansines modas - kiekvienas dažnis sužadina skirtingas paviršines stovinčias ir bėgančias bangas(nors techniškai tai visai skirtingos modos su skirtingais tvirtinimais ir t.t.). Kas DML gražu, tai tas, kad bet kas gali tapti garsiakalbiu! Bet kas, kas gali vibruoti, tai yra. Stalas, kėdė, siena, langas, ar pieno pakelis...
...
Skirtumas tarp stūmoklio ir paskirstytų modų veikimo tampa aiškus, kai vizualizuojate paviršiaus judesį:
...
sketch.draw = () => {
  ...
  sketch.text(showDML ? "DML - paskirstytos modos" : "Garsiakalbiai - stūmoklio moda", 
              sketch.width/2, 30);
...
Spustelėkite „Toggle Mode“, kad perjungtumėte tarp vizualizacijos režimų. DML plokštė rodo kelias vienu metu veikiančias rezonansines modas - kiekvienas dažnis sukuria skirtingas stovinčas ir bėgančias bangas. Įprastų garsiakalbių diafragma juda vientisai (išskyrus kuomet žadinamas signalo dažnis viršija lūžio tašką kuomet diafragmoje susidaro stovinčios bangos - paprastai tai yra didelis blogis garso kokybei).

Dar svarbiau, garsiakalbis juda kaip stūmoklis, stumiantis ir traukiantis orą, kurdamas garsą ir sąveikauja su dėžės vidumi bei pačia dėže kuri taip pat skleidžia garsą net jei pagaminta iš betono. Labai nedaug garso šaltinių veikia šitaip. DML daro kitaip - visas paviršius leidžiamas laisvai vibruoti ir visas paviršius skleidžia garsą. Labai panašiai kaip įvairūs muzikos instrumentai. Triukas yra žadinti plokštę taip, kad būtų sužadinamos tik reikiamos modos. Iš tiesų, kuo daugiau dažnių sužadina stovinčias bangas - tuo geriau. Nebent tai bėgančios bangos moda - tuomet stovinčios bangos kaip ir žalingos. Kita vertus, pritaikius skaitmeninį signalų apdorojimą galima kovoti su atkūriamų dažnių netolygumu protingose ribose.
...
Galima iš lempos klijuot tuos exciterius, tačiau galima ir paoptimizuot truputį, kad gautųsi "skambesnės" modos. Lubos visgi yra iš visų galų įtvirtintos plokštės, todėl dominuoja stovinčios bangos. Tačiau konkrečiai mano lubos buvo pusiau priklijuotos prie medinio rėmo ir yra šiek tiek laisvos. Taigi jos gerokai slopinamos, todėl vibracijos toli nenukeliauja. Nors vibracijas vis tiek galiu pajusti priešingame vonios lubų kampelyje.

Bet kuriuo atveju, štai ką padariau - pritvirtinau exciterius pagal intuiciją - kažkur arčiau kampų viduryje tarp kampų ir centro ir pan. Stengiausi pataikyti tarp medinių balkių. Bandžiau matuoti atsakus skirtingose vietose ir galiausiai vietą pasirinkau pagal geriausią dažninį atsaką bei mažiausius iškraipymus.
REW gali parodyti iškraipymus ir skambėjimą, tai buvo labai naudinga.

# Dažnių atsakas ir DSP korekcija

Neapdorotas DML atsakas rodo 15-20 dB svyravimą per garso juostą. Modaliniai rezonansai sukuria viršūnes, o anti-rezonansai sukuria įdubas:

![Dažnių atsako grafikas, rodantis žalią matavimą su akivaizdžiomis viršūnėmis apie 300Hz, 800Hz, 2kHz ir įdubomis ties 500 Hz ir 1,5 kHz. Y ašis: SPL (dB), X ašis: Dažnis (Hz, log skalė)](response-before-calibration.jpg)

Nekalibruotas atsakas rodo:
- Žemų dažnių kritimą žemiau 80 Hz
- Tačiau iškraipymai šauna į viršų žemiau 190 Hz (iki 10% dar pakenčiama)
...
Tačiau vienas trūkumas su tvirtinimu yra tas, kad vargšės lubos nebuvo suprojektuotos atsižvelgiant į vibracijas. Nors plastikinės plokštės yra pritvirtintos prie medinio rėmo (manau klijais), jos vis tiek rodo trinties požymius visur, kur susitinka ar susijungia dvi plokštės. Ir tai lemia cypimus ir kitokius nemalonius artefaktus padidinus galią.
...
Galbūt tiesiog pakabinsiu 1×0,7 m akrilines plokštes kurios ir atliks DML funkciją, kad atriščiau nuo lubų - bus paprasčiau suderint ir padidint galią...

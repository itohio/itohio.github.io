...
Sublimacijos spaudiniai nėra blogi. Darktable integruotam spalvų kalibravimui 24 lopų lentelė iš tikrųjų pakanka. Tačiau matavimas CR30 atskleidė problemą: CMY gamutas smarkiai nukerpa tam tikras raudonas ir geltonas spalvas. ΔE tose lopų vietose pakankamai didelis, kad gautą profilį padarytų nepatikimu bet kam rimtesniam.
...
Substratas: maži kvadratai, iškirpti iš kieto balto plastiko lapo, dažyti atskirai, kad kiekvieną lopą būtų galima permatuoti ir perdažyti nekeičiant visos lentelės.

![Akrilinių dažų paletė su pirminių spalvų pavyzdžiais — sausi](acrylic-palette-dry.jpg)

Pirminės spalvos: mėlyna, žalia, juoda, geltona, raudona, pilka, balta. Pavyzdžiai dėkle — išdžiovinti mėginiai, iškirpti iš plastiko lapo.
...
Darktable spalvų kalibravimo modulis veikia fotografuojant žinomą spalvų etaloną tomis pačiomis sąlygomis kaip ir fotografuojamas objektas, po to apskaičiuojant 3×3 matricą (su poslinkiais), kuri susieja kameros neapdorotą atsaką su etalono Lab reikšmėmis. Įprastai nusipirktum ColorChecker arba SpyderChecker. Šios savadarbės lentelės yra pigesnė alternatyva — jei etaloninės reikšmės, kurias paduodi Darktable, iš tikrųjų atitinka tai, kas yra ant fizinės lentelės.
...
Dauguma vartotojų monitoriaus kalibratorių — Datacolor Spyder X, X-Rite ColorMunki Display — matuoja tik RGB (arba kelias plačias juostas). Tai suteikia pakoreguotą gamos kreivę ir baltą tašką, kas tinka ekrano kalibravimui, bet neparodo tikrojo spektrinės galios skirstinio tavo monitoriaus pirminių spalvų. Rimtam spalvų darbui — suprasti *kodėl* monitoriaus gamas turi tokią formą, arba patvirtinti, kad ekranas iš tikrųjų gali atkurti tavo kalibravimo darbo eigoje esančias spalvas — reikia spektrinių duomenų.

CR30 matuoja tik atspindėtą spektrą — emisiniai ekranai jam visiškai nepasiekiami. Žemiau pateikti ekrano spektrai užfiksuoti su savo rankomis sukurtu matomojo spektro spektrometru. Mėlynas ir žalias kanalai maždaug tokie, kokių tikėtumeisi iš tipinio IPS skydelio. Raudonas kanalas įdomesnis.

![Monitoriaus pirminių spalvų emisijos spektras, išmatuotas savarankiškai sukurtu spektrometru — žalias platus kupolas apie 530 nm, raudono kanalo dvi siauros fosforo smailės apie 600 nm ir 635 nm](monitor-spectrum.jpg)
*ThinkPad ekrano emisijos spektras. Žalias: platus kupolas, centruotas apie 530 nm. Raudonas: dvi siauros fosforo smailės — antrinė ties ~600 nm, pagrindinė ties ~635 nm. Tiek ThinkPad, tiek žaidimų monitorius rodo panašų padalytą raudoną. Palyginimui — mano OLED telefonas turi platesnį, lygesnį raudoną kanalą.*

Dviguba smailė — tai, kas svarbu kolorimetrijai: antrinis ties 600 nm reiškia, kad ekrano raudonas neša reikšmingą oranžinį komponentą. Akiai tai nesvarbu — regėjimo sistema integruoja per visą kanalą. Kalibravimo darbui tai sisteminė klaida, kurią 3×3 matricos korekcija gali tik iš dalies kompensuoti.

Tinkamam monitoriaus charakterizavimui reikėtų spektrofotometro su emisiniu režimu — i1Display Pro Plus arba idealiai i1Pro 3. CR10 kolorimetras, kurį turiu, irgi galėtų tikti: jis veikia su ESP32 mikrovaldikliu, todėl programinę įrangą turėtų būti įmanoma perdaryti ir pridėti emisinio matavimo režimą — nors dar neprisikasiau. Kainų skirtumas tarp paprasto kolorimetro ir tikro spektrofotometro bet kuriuo atveju yra nemažas, ir dar neišrinkau nė vieno.

Tai veda prie kitos problemos dalies: net turėdamas tobulą kalibratorių ir tobulą savadarbę lentelę, dabartinis monitorius tikriausiai nėra tinkamas įrankis nuotraukų ir vaizdo darbui. Tai atskiras pirkimo sprendimas, ir stengiuosi jo nepriimti tol, kol tiksliai nesuprantu, kokie iš tikrųjų yra dabartinio ekrano spektriniai apribojimai.

## Kur esame dabar

Akrilinė lentelė padaryta. Ar ji pakankamai tiksli — vis dar nežinoma: tai priklausys nuo to, ar lopai bus tinkamai sunumeruoti ir patvirtinti prieš SpyderChecker 24 žinomas Lab reikšmes, ko kol kas neįvyko. Senėjimo testas taip pat neįvyko. Likusios užduotys yra labiau fundamentalios nei atrodė pradžioje: fotografuoti abi lenteles kontroliuojamoje šviesoje, paleisti per ArgyllCMS ir palyginti korekcijas, kai etaloninės reikšmės bus patikimos.

Sunkesnis klausimas pasirodė esantis monitorius. Lentelė gali jau būti tikslesnė už ekraną, kurį ji turi kalibruoti — o prietaisas, reikalingas tam ekranui tinkamai apibūdinti, kainuoja daugiau nei pats ekranas. Sublimacijos spaudiniai vis dar naudingi kaip greitas bazinis lygis. Akrilinė lentelė laukia patikimo kalibratoriaus kitame gale.

...
Vieno puslapio žinynas su santrumpomis ir terminais, kurie užpildo kiekvieną FPV forumo postą ir Discord serverį. Sudėliota pagal sritis, kad susiję terminai liktų kartu.
...
| **ESC** | Electronic Speed Controller | Verčia FC motorų komandas į trifazę kintamąją srovę brushless motorams |
...
| **VRX** | Video Receiver | Goggles pusės imtuvas analoginiam vaizdui; digital sistemose jį pakeičia display'as |
...
| Terminas | Reikšmė |
|------|---------|
| **KV** | Motoro greičio konstanta: RPM voltui be apkrovos. 2400 KV su 4S → ~40 000 RPM be apkrovos, esant 16,8 V. Mažesnis KV = daugiau sukimo momento, didesni propai. |
...
| **Pole count** | Magnetų polių skaičius; lemia santykį tarp mechaninių RPM ir elektrinio dažnio. 12N14P = 12 statoriaus dantų, 14 magnetų polių. |
| **eRPM** | Elektriniai RPM = mechaniniai RPM × (poliai / 2). Naudoja RPM filter ir DSHOT telemetrija. |
| **Prop notation** | pvz., **5148**: pirmieji du skaitmenys = skersmuo colio dešimtosiomis (5,1"), kiti du = pitch dešimtosiomis (4,8"). |
...
| **C-rating** | Maksimalaus nuolatinio išsikrovimo daugiklis. 75C su 1300 mAh = 97,5 A maks. nuolat. C-rating'us vertink skeptiškai — gamintojai juos pučia. |
...
| **Sag** | Įtampos kritimas patraukus full throttle. Stiprus sag → FC brownout ir perkrovimas. |
...
| **UBEC** | Universal BEC. Impulsinis reguliatorius; efektyvesnis nei linijiniai BEC, kai įtampos kritimas didesnis. |
...
| Terminas | Reikšmė |
|------|---------|
| **ELRS** | ExpressLRS. Atviro kodo long-range RC ryšys. 2,4 GHz arba 900 MHz. Itin maža latencija (3–6 ms ties 500 Hz), didelis nuotolis, nemokamas. |
...
| **SNR** | Signal-to-Noise Ratio. Kiek dB signalas viršija triukšmo lygį. Neigiamas SNR ELRS'e vis dar tinkamas naudoti. |
...
| **Arming** | Būsena, kai motorai įjungti. Daugumai setup'ų reikia: gero RC ryšio, jokių arming flag'ų, arm jungiklio. |
...
| **RPM filter** | Dinaminiai notch filtrai, susieti su motorų elektriniais RPM per DSHOT telemetriją. Reikia bidirectional DSHOT. |
| **Dynamic notch** | Savaime prisitaikantis notch filtras, sekantis dominuojančius triukšmo dažnius gyro signale. |
| **TPA** | Throttle PID Attenuation. Sumažina P (ir pasirinktinai D) esant aukštam throttle, kad kompensuotų greitesnį motorų atsaką prie aukštų RPM. |
...
| **Turtle mode** | Flip-over-after-crash. Apsuka motorus, kad apverstų droną teisinga puse ir nereikėtų prie jo eiti. |
...
| **DVR** | Digital Video Recorder. Įrašo FPV vaizdą goggles'uose avarijų peržiūrai ir turiniui. |
...
| Konstrukcijos tipas | Tipiškas motoras | Tipiškas propas | Baterija |
|-----------|--------------|-------------|---------|

...
**A 2.5" long-range experimental platform** — second attempt, heavier frame. Running an 18650 cell, 120g AUW. Sintra helped get the tune to the point where the build would actually lift the heavy cell reliably. It flies — but voltage sag under load means GPS rescue triggers and forces it home before the 5-minute mark. Around 4 minutes of usable flight time, which is poor given the 2" rippers do 6 minutes on 580mAh and are significantly faster. GPS itself works far better than the Pavo20. The 2S or 3S conversion isn't built yet.
